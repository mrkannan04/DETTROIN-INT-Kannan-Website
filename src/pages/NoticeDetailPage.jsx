      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-6">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-100 text-slate-700 text-xs font-bold rounded-xl border border-slate-200 shadow-sm transition-colors"
          >
        ...
        <ImageReveal>
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-card border border-slate-200 space-y-8">
            ...
            <div className="border-b border-slate-200 pb-6 space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={handleShare}
                    className="p-2.5 rounded-full bg-slate-100 hover:bg-kis-gold hover:text-kis-navy text-slate-600 transition-colors shadow-sm"
            ...
            {/* Notice Body Content */}
            <div className="prose max-w-none text-slate-700 text-base leading-relaxed whitespace-pre-line text-justify font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedNotices.map((rel) => (
              <ImageReveal key={rel.id}>
                <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 h-full flex flex-col justify-between">
                  <div>
