      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <address className="not-italic text-sm text-footer-text leading-relaxed space-y-2 pt-2">
              <a
          ...
          <div className="space-y-4">
            <h4 className="text-base font-bold text-footer-heading uppercase tracking-wider border-b-2 border-gold-accent pb-2 inline-block">
              Contact & Socials
            </h4>
            <div className="space-y-3 text-sm text-footer-text">
              ...
              <div className="flex items-center gap-2.5 pt-1">
                ...
                <a href="mailto:info@kisaligarh.com" className="hover:text-gold-accent transition-colors">
                  info@kisaligarh.com
                </a>
              </div>
            </div>
            ...
            <div className="pt-2">
              <p className="text-xs uppercase font-bold text-navy-muted mb-2">Connect With Us</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 pt-1">
              ...
              >
                ...
                <div>
                  ...
                  <div className="font-bold text-navy-deep leading-tight">Google Play</div>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  ...
                  <div className="font-bold text-navy-deep leading-tight">App Store</div>
                </div>
              </Link>
            </div>
            ...
            <div className="bg-bg-secondary border border-border-hairline rounded-xl p-3 flex items-center gap-3">
              <div className="w-14 h-14 bg-bg-primary rounded-lg p-1.5 shrink-0 flex items-center justify-center shadow-inner">
              ...
              <div>
                ...
                <span className="text-sm font-extrabold text-gold-accent tracking-widest uppercase block">
                  DEMO123
                </span>
