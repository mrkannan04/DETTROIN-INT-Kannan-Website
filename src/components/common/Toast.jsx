...
export const Toast = ({ message, type = 'success', onClose, duration = 4000 }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-bounce duration-300 max-w-md w-full px-4">
      <div className={`bg-white rounded-2xl shadow-xl border-l-4 ${isSuccess ? 'border-kis-accent-teal' : 'border-red-500'} p-4 flex items-start justify-between gap-3 border border-slate-200`}>
